        ...
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST_URL)
                                .permitAll()
                                .requestMatchers(GET,"/employee","/employee/{id}").hasAnyAuthority(ADMIN_READ.getPermission())
                                .requestMatchers("/department","/department/{id}").hasAnyAuthority(DEP_UPDATE.getPermission())
                                .requestMatchers("/patient","/patient/{id}","patient/transfer/{id}").hasAnyAuthority(DESK_READ.getPermission())
